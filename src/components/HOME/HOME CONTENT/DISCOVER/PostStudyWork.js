							...
							<div className=" bg-gray-100 lg:px-8 px-3 py-3 pb-10  ">
								...
								<div className="text-md breadcrumbs md:px-1   lg:mx-[55px] ">
									<ul className="text-sky-700 ">
										...
										<li>
											<p className="text-black"> Post study work </p>
										</li>
									</ul>
								</div>
								{/* breadcrumb end */}

								{/* About the post study work*/}

								<div className="  ">
									<h1 className="mb-3 border-t-4 border-sky-700 lg:mx-20 mx-3 mt-2"></h1>
									<h1 className="text-sky-700 text-xl font-bold lg:px-20  ">
										Australia now offers up to 4 years of post-study work rights
									</h1>

									<div className="lg:px-20">
										<h1 className="mt-2 text-sky-700 text-xl font-bold   ">
											Introduced on 16th November 2019, the new visa allows
											post-study work rights for international students up to 4
											years in regional Australia
										</h1>

										<p className="   text-justify my-5 ">
											If you have been aspiring to study in Australia, there is
											one more reason to lock on to your decision – the latest
											update on the new 485 post-study work stream visa! Now you
											can enjoy extended post-study work rights in Australian
											regional areas and live your dream.
										</p>
										...
										<p className="text-justify mt-5">
											With the recent changes declared by the Australian
											Government, Australia now offers up to 4 years of
											Post-Study Work (PSW) rights to international students
											post completion of their respective Bachelors or Masters
											Degree in regional areas. A few top and popular cities
											such as Perth, Adelaide, Gold Coast, Sunshine Coast,
											Canberra, Newcastle/Lake Macquarie, Wollongong/Illawarra,
											Geelong and Hobart now offer 1 year of additional PSW
											(total of 3 years). In fact, there is a{" "}
											<span className="text-sky-700 cursor-pointer hover:underline">
												list of cities
											</span>{" "}
											where you become eligible for PSW for up to 4 years upon
									...
									<div>
										...
										<p className=" lg:px-20 px-3 text-justify mt-3 ">
											It’s a great opportunity to stay back and work in
											Australia for a longer duration! This new post-study work
											stream visa, offered by the Australian Government enables
											you to study, live, and work in the designated regional
											areas of the country, for up to four years. This is a
											great update as now you can plan for your career in a
											better manner, having a wider range of areas accessible to
