...
import UgInsuranceDetails from "./UgInsuranceDetails";
import UgInsuranceMain from "./UgInsuranceMain";
import UgInsuranceSidebar from "./UgInsuranceSidebar";
				...
				<div className="lg:mx-[100px]">
					<div className="grid   lg:grid-cols-2 sm:grid-cols-1">
						...
						<div className="lg:ml-[200px] mt-4">
							<UgInsuranceSidebar></UgInsuranceSidebar>
						</div>
					</div>
					<div>
						<UgInsuranceMain></UgInsuranceMain>
					</div>
				</div>
				<div className="container lg:mr-52">
					<UgInsuranceDetails></UgInsuranceDetails>
				</div>
			</div>
		</div>
	);
