...
import MastersFinanceSidebar from "./MastersFinanceSidebar";
					...
					<div className="grid   lg:grid-cols-2 sm:grid-cols-1">
						<div className="shadow lg:w-full lg:mx-20  ">
							<div className=" bg-base-100 lg:px-8 px-3  pb-10 ">
								...
								<p>
									Full time: 2 years full time for domestic and international
									students
								</p>
								<p>
									Part time: 4 years part time available for domestic students
									only
								</p>
								...
								<div className="  ">
									...
									<p className="  text-justify mt-3">
										The degree of Master of Philosophy (MPhil) in Islamic
						...
						<div className="lg:ml-[200px] mt-4">
							<MastersFinanceSidebar></MastersFinanceSidebar>
						</div>
					</div>
					<div>
