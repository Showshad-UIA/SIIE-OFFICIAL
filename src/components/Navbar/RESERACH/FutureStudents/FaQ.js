	...
	return (
		<div className="container mx-auto ">
			<div className="lg:mx-[150px] pb-16">
				...
				>
					...
					<div className="collapse-content">
						<p className="my-3">
							...
							list of approved ways to meet these requirements, visit SYDNEY IBS
				...
				>
					...
					<div className="collapse-content">
						...
						<p className="mb-3">
							...
							information, see the Document Submission Guidelines at this page.
						</p>
				...
				>
					...
					<div className="collapse-content">
						<p className="my-3">
							...
							academic requirements as outlined in the Higher Degree Research
							Scholarships Procedure. Of these potential applicants only an
							estimated 10% of Internationals are competitive for a main
							scholarship. Therefore if you require a scholarship, it is
							imperative that you secure a supervisor stipend for TFS
							consideration.
						</p>
					</div>
				</div>
				...
				>
					<div className="collapse-title text-xl font-medium text-sky-700">
						How do I track the status of my application and check all documents
						are received?{" "}
					</div>
					<div className="collapse-content">
						<p className="my-3">
						...
						<p className="">
							...
							Scholarships team at the Graduate Research School
							domestic.grs@SYDNEY IBS.edu.au or international.grs@SYDNEY IBS.edu.au or for
							Canberra applicants the Admin Research Student Unit:
							rsu@adfa.edu.au. If you applied through a SYDNEY IBS agent, please
				...
				>
					...
					<div className="collapse-content">
						...
						<p className="mb-3">
							All scholarship outcomes are sent from the release date outlined
							on this page. This process takes several weeks as all applicants
							must be contacted.
						</p>
					</div>
				</div>
				...
				>
					...
					>
						...
						<div className="collapse-content">
							...
							<p className="mb-3">
								...
								outlined in Key Dates. Results cannot be released prior to the
					...
					>
						...
						<div className="collapse-content">
							...
							<p className="mb-3">
								See 'Responding to an Offer' on this page for instructions on
								deferral.
							</p>
						</div>
					</div>
					...
					>
						<div className="collapse-title text-xl font-medium text-sky-700">
							...
							scholarship payments, but when I log onto MySYDNEY IBS it asks me to pay
							the tuition fee. What should I do?
						</div>
						<div className="collapse-content">
							<p className="my-3">
