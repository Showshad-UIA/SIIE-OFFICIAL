...
const UgCourseYearTwo = () => {
	return (
		<div className="lg:w-[50%] lg:mx-auto sm:w-full">
			<div class="overflow-x-auto relative shadow-md sm:rounded-lg ">
				<h1 className="text-center border-l-2 border-r-2 border-gray-300 py-4">
					Year 2
				</h1>
				<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border border-gray-300">
					...
					<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
						<tr>
							<th scope="col" class="py-2 border border-gray-300 px-6">
								Course code
							</th>
							<th scope="col" class="py-2 border border-gray-300 px-6">
								Course title
					...
					<tbody>
						<tr class="bg-gray border-b dark:bg-gray-900 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">Islamic Finance</td>
						...
						<tr class="bg-gray border-b dark:bg-gray-900 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">
								Islamic Jurisprudence of Contemporary Financial Transactions
							</td>
							<td class="py-2 border border-gray-300 px-6">Core</td>
							<td class="py-2 border border-gray-300 px-6">
								<button className="bg-sky-700 w-18 h-7 hover:bg-blue-700 text-white font-bold px-2 rounded">
						...
						<tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">
								Descriptive Statistics for Economists/Finance
							</td>
							<td class="py-2 border border-gray-300 px-6">Core</td>
							<td class="py-2 border border-gray-300 px-6">
								<button className="bg-sky-700 w-18 h-7 hover:bg-blue-700 text-white font-bold px-2 rounded">
						...
						<tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">
								Mathematics for Business Management II
							</td>
							<td class="py-2 border border-gray-300 px-6">Core</td>
							<td class="py-2 border border-gray-300 px-6">
								<button className="bg-sky-700 w-18 h-7 hover:bg-blue-700 text-white font-bold px-2 rounded">
						...
						<tr class="bg-gray border-b dark:bg-gray-900 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">
								Regulation, Supervision & Control of Islamic Banks
							</td>
							<td class="py-2 border border-gray-300 px-6">Elective</td>
							<td class="py-2 border border-gray-300 px-6">
								<button className="bg-sky-700 w-18 h-7 hover:bg-blue-700 text-white font-bold px-2 rounded">
						...
						<tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700">
							...
							></th>
							<td class="py-2 border border-gray-300 px-6">
								Islamic Financial Plan Construction & Professional
								Responsibilities
							</td>
							<td class="py-2 border border-gray-300 px-6">Elective</td>
							<td class="py-2 border border-gray-300 px-6">
...
export default UgCourseYearTwo;
