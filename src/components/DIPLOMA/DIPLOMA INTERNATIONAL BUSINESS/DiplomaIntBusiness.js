...
import DiplomaIntBusinessDetails from './DiplomaIntBusinessDetails';
import DiplomaIntBusinessMain from './DiplomaIntBusinessMain';

const DiplomaIntBusiness = () => {
    return (
        <div className="">
	{/* PhD sub pages added here using breadcrumbs */}
				...
				<div className="lg:mx-[100px] shadow">
					<div className="text-sm breadcrumbs  lg:px-3 md:px-6 px-6  lg:mx-[100px] ">
						<ul>
							...
							<li>
								<a href="/diplomafinance">Diploma in Islamic</a> finance and banking
							</li>
							<li>
			...
			<div className="container mx-auto  lg:mb-16 lg:mt-7 ">
				<div className="lg:mx-[100px] shadow">
					...
					<div className="">
						<DiplomaIntBusinessMain></DiplomaIntBusinessMain>
					</div>
				</div>
				<div className="container lg:mr-52 ">
					<DiplomaIntBusinessDetails></DiplomaIntBusinessDetails>
				</div>
			</div>
		</div>
    );
...
export default DiplomaIntBusiness;