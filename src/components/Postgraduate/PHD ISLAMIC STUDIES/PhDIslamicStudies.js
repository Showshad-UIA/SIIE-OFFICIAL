...
import PhDIslamicStudyDetails from './PhDIslamicStudyDetails';
import PhDIslamicStudyMain from './PhDIslamicStudyMain';
import PhDIslamicStudySidebar from './PhDIslamicStudySidebar';

const PhDIslamicStudies = () => {
    return (
        <div>
        ...
        <div className="lg:mx-[100px]">
            <div className="grid   lg:grid-cols-2 sm:grid-cols-1">
                ...
                <div className="lg:ml-[200px] mt-4">
                    <PhDIslamicStudySidebar></PhDIslamicStudySidebar>
                </div>
            </div>
            <div>
                <PhDIslamicStudyMain></PhDIslamicStudyMain>
            </div>
        </div>
        <div className="container lg:mr-52">
            <PhDIslamicStudyDetails></PhDIslamicStudyDetails>
        </div>
    </div>
    </div>
    );
...
export default PhDIslamicStudies;