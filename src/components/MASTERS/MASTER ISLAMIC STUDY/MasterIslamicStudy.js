...
import MasterIslamicStudyDetails from './MasterIslamicStudyDetails';
import MasterIslamicStudyMain from './MasterIslamicStudyMain';
import MasterIslamicStudySidebar from './MasterIslamicStudySidebar';

const MasterIslamicStudy = () => {
    return (
        <div>
        ...
        <div className="lg:mx-[100px]">
            <div className="grid   lg:grid-cols-2 sm:grid-cols-1">
                ...
                <div className="lg:ml-[200px] mt-4">
                    <MasterIslamicStudySidebar></MasterIslamicStudySidebar>
                </div>
            </div>
            <div>
                <MasterIslamicStudyMain></MasterIslamicStudyMain>
            </div>
        </div>
        <div className="container lg:mr-52">
            <MasterIslamicStudyDetails></MasterIslamicStudyDetails>
        </div>
    </div>
    </div>
    );
...
export default MasterIslamicStudy;