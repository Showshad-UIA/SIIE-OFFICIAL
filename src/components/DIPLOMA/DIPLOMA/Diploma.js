...
import DiplomaSidebar from './DiplomaSidebar';
            ...
            <div className="lg:mx-[100px] shadow">
                <div className="text-sm breadcrumbs  lg:px-3 md:px-6 px-6  lg:mx-[100px] ">
                    <ul>
                        ...
                        <li>
                            <a href="/diplomafinance">Diploma in Islamic banking and finance</a>
                        </li>
                        <li>
            ...
            <div className="lg:mx-[100px] shadow ">
                        ...
                        <div className=" bg-base-100 lg:px-8 px-3 py-3 pb-10  ">
                            ...
                            <div className="  ">
                                ...
                                <p className=" lg:px-20 px-3 text-justify mt-3 ">
                                    ...
                                    specialising. diploma applicants are obliged to take a number of
                ...
                <div className="lg:mx-[100px] pb-10">
                    ...
                    <div className="flex bg-sky-500 shadow p-3 mb-5 gap-5">
                        ...
                        <div className='w-[75%]'>
                            <a href="/diplomaeconomics">
                                <p className="text-2xl mb-5 text-white">Graduate Diploma in Islamic Economics</p>
                    ...
                    <div className="flex bg-sky-500 p-3 mb-5 gap-5">
                        ...
                        <div className='w-[75%]'>
                            <a href="#">
                                <p className="text-2xl text-white mb-5">Graduate Diploma in Islamic Insurance</p>
