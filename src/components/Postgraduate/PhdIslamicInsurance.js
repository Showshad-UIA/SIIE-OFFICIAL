...
import PhdIslamicInsuranceSidebar from "./PhdIslamicInsuranceSidebar";

const PhdIslamicInsurance = () => {
	return (
		<div className=" lg:mx-[20px]  ">
			<div className="grid text-center lg:mt-[100px] gap-20 sm:mt-10  lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1">
				...
				<div className="lg:mx-[150px] lg:ml-[230px] lg:mt-[-16px]  ">
					<div className="lg:mt-[140px]">
						<PhdIslamicInsuranceSidebar></PhdIslamicInsuranceSidebar>
					</div>
				</div>
			</div>
		</div>
