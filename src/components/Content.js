...
const Content = () => {
	return (
		...
		// <div class=" bg-base  lg:w-full sm:w-4/5">
		// 	<div class=" flex-col  lg:flex-row-reverse">
		// 		{/* <figure class="px-10 ml-16">
		// 				<a href="#">
		// 					<FontAwesomeIcon
		// 						icon={faArrowLeft}
		// 						className="h-[40px] w-[40px] text-green-700"
		// 					></FontAwesomeIcon>
		// 				</a>
		// 			</figure> */}
		// 		<div>
		...
		// 			</h1>
		// 			<p class="py-3 text-lg text-justify m-auto">
		// 				SIIE will be partnering with Australian education institutions so
		// 				that students can get a step closer to realising their business
		// 				dreams. SIIE with its panel of academic and industry experts will
		// 				conduct an initial assessment and evaluate on feasibility,
		// 				financing, market potential, market need (actual or perceived) and
		// 				scalability of the business. Once the business proposal has been
		// 				reviewed, targeted feedback will be provided so students can
		// 				implement and adjust their business proposal accordingly. SIIE will
		// 				then arrange for students’ product/service to develop into a
		// 				tangible prototype. Finally, if successful, SIIE will give access to
		// 				potential investors so students can get funding for their business
		// 			</p>
		// 		</div>
		// 	</div>
		// </div>
