...
import MasterIslamicInsuranceSidebar from './MasterIslamicInsuranceSidebar';
							...
							<div className=" lg:w-full    ">
								<div className=" bg-base-100 lg:px-8 px-3 py-3 pb-10  ">
									...
									<div className="  ">
										...
										Sydney Islamic Business School (Sydney IBS) offers master programs across all disciplines within Islamic Business. The master program consists of two components– coursework and research. Before completing their research, Sydney IBS master candidates are required to complete 36 units of credit worth of coursework units, usually during their first 18 months of study, to assist them in completing their dissertation. Master candidates are required to submit a thesis which should not exceed 100,000 words. The thesis must be an original work that not only demonstrates the candidate’s ability to undertake world-class research, but that also makes a substantial contribution to the advancement of knowledge in their chosen area of study. Admission requirements, program structure and program duration vary by discipline. You should carefully review all discipline-specific information before applying for entry to a master program. 
										</p>
